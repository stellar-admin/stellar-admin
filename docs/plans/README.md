...
| Plan | Status |
| --- | --- |
| [Workspace and skills consolidation](workspace-retirement.md) | active — step 1 committed; step 2 contributor guidance implemented and verified locally; website remains separate |
