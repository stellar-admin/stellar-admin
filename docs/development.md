...
| Dashboard | Build `src/StellarAdmin.Dashboard/StellarAdmin.Dashboard.csproj`. EF Core is included again with a read-only resource index. Identity and its playground remain excluded during the resource redesign. |
