...
using StellarAdmin.Dashboard.Identity.Areas.StellarAdmin.Controllers;
using StellarAdmin.Dashboard.Identity.Builders;
using StellarAdmin.Dashboard.Identity.Infrastructure;
using StellarAdmin.Dashboard.Identity.Options;
using StellarAdmin.Dashboard.Identity.Sidebar;
using StellarAdmin.Dashboard.Sidebar;

namespace StellarAdmin.Dashboard.Identity;
...
public static class StellarAdminDashboardBuilderExtensions
{
    extension(StellarAdminDashboardBuilder builder)
    {
        ...
        ///     The Identity role type the host registered with <c>AddIdentity</c> or <c>AddRoles</c>.
        /// </typeparam>
        public StellarAdminDashboardBuilder AddIdentity<TUser, TRole>(
        ...
        ///     The type of the primary key for a user and a role.
        /// </typeparam>
        public StellarAdminDashboardBuilder AddIdentity<TUser, TRole, TKey>(
    ...
    ) AddIdentityCore<TUser, TKey>(StellarAdminDashboardBuilder builder)
        where TUser : IdentityUser<TKey>
        where TKey : IEquatable<TKey>
    {
    ...
    private static IdentityRolesOptions<TRole, TKey> AddRolesCore<TRole, TKey>(
        StellarAdminDashboardBuilder builder,
        StellarAdminIdentityOptions options
    )
        where TRole : IdentityRole<TKey>
        where TKey : IEquatable<TKey>
