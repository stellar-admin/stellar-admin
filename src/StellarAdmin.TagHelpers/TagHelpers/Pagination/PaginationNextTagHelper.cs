...
public class PaginationNextTagHelper : StellarAdminAnchorTagHelperBase
{
    ...
    public PaginationNextTagHelper(IHtmlGenerator htmlGenerator, IOptions<IconOptions> iconOptions)
    {
