...
```bash
dotnet build stellar-admin/tests/StellarAdmin.Pro.EntityFrameworkCore.Tests -m:1
dotnet run --project stellar-admin/tests/StellarAdmin.Pro.EntityFrameworkCore.Tests --no-build
```
