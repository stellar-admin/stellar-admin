...
{
    [Test]
    public async Task ProcessAsync_WhenGroupsAreGenerated_AppliesClassesToExpectedElements()
    {
        // Arrange
        ...
        await Assert
            ...
            .IsEqualTo(1);
        await Assert.That(html.QuerySelectorAll(".otp-group").Length).IsEqualTo(2);
        await Assert
            .That(html.QuerySelectorAll("div.sa-input-otp-group.otp-group").Length)
            .IsEqualTo(2);
        await Assert.That(html.QuerySelectorAll(".otp-slot").Length).IsEqualTo(4);
        await Assert
        ...
        await Assert
            ...
            .IsEqualTo(1);
        await Assert.That(html.QuerySelectorAll(".sa-input-otp-group").Length).IsEqualTo(2);
        await Assert.That(html.QuerySelectorAll(".sa-input-otp-slot").Length).IsEqualTo(4);
